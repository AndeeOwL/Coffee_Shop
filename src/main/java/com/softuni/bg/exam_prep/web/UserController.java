...
import com.softuni.bg.exam_prep.model.binding.UserLoginBindingModel;
import com.softuni.bg.exam_prep.model.binding.UserRegisterBindingModel;
...
public class UserController {
    ...
    public String registerConfirm(@Valid UserRegisterBindingModel userRegisterBindingModel,
        ...
        if (bindingResult.hasErrors() || !userRegisterBindingModel.getPassword()
                .equals(userRegisterBindingModel.getConfirmedPassword())){
